...
class SearchListAdapter(val mContext: Context) : RecyclerView.Adapter<ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = mInflater?.inflate(R.layout.search_list_item_single_image, parent, false)
